...
public class Perg6Activity extends AppCompatActivity {
    private RadioGroup alternativas;
    private Button proxima;
    private int alternativaCorreta = R.id.perg6_1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_perg6);

        alternativas = (RadioGroup) findViewById(R.id.perg6_alternativas);
        proxima = (Button) findViewById(R.id.perg6_proxima);
    ...
    private void enviaDados(View v, int contaAcertos, int contaErros) {
        Intent intent = new Intent(Perg6Activity.this, Perg7Activity.class);
