...
public class Perg9Activity extends AppCompatActivity {
    private RadioGroup alternativas;
    private Button proxima;
    private int alternativaCorreta = R.id.perg9_1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_perg9);

        alternativas = (RadioGroup) findViewById(R.id.perg9_alternativas);
        proxima = (Button) findViewById(R.id.perg9_proxima);
    ...
    private void enviaDados(View v, int contaAcertos, int contaErros) {
        Intent intent = new Intent(Perg9Activity.this, Perg10Activity.class);
