...
public class Perg3Activity extends AppCompatActivity {
    private RadioGroup alternativas;
    private Button proxima;
    private int alternativaCorreta = R.id.perg3_3;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_perg3);

        alternativas = (RadioGroup) findViewById(R.id.perg3_alternativas);
        proxima = (Button) findViewById(R.id.perg3_proxima);
    ...
    private void enviaDados(View v, int contaAcertos, int contaErros) {
        Intent intent = new Intent(Perg3Activity.this, Perg4Activity.class);
