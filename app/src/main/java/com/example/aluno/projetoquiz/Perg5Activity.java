...
public class Perg5Activity extends AppCompatActivity {
    private RadioGroup alternativas;
    private Button proxima;
    private int alternativaCorreta = R.id.perg5_1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_perg5);

        alternativas = (RadioGroup) findViewById(R.id.perg5_alternativas);
        proxima = (Button) findViewById(R.id.perg5_proxima);
    ...
    private void enviaDados(View v, int contaAcertos, int contaErros) {
        Intent intent = new Intent(Perg5Activity.this, Perg6Activity.class);
