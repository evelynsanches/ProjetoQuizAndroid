...
public class Perg4Activity extends AppCompatActivity {
    private RadioGroup alternativas;
    private Button proxima;
    private int alternativaCorreta = R.id.perg4_1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_perg4);

        alternativas = (RadioGroup) findViewById(R.id.perg4_alternativas);
        proxima = (Button) findViewById(R.id.perg4_proxima);
    ...
    private void enviaDados(View v, int contaAcertos, int contaErros) {
        Intent intent = new Intent(Perg4Activity.this, Perg5Activity.class);
